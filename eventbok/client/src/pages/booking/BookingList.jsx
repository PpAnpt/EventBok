                ...
                <tr key={b.booking_id} style={{ borderBottom: "1px solid var(--color-border)" }}>
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <div style={{ display: "flex", gap: 6 }}>
                      <button onClick={() => setViewing(b)} title="View" style={{ background: "none", border: "none", cursor: "pointer", fontSize: 11, padding: 4, color: "#6b7280", fontWeight: 600 }}>View</button>
                      {b.status === "pending" && <button onClick={() => updateStatus(b.booking_id, "confirm")} title="Confirm" style={{ background: "none", border: "none", cursor: "pointer", fontSize: 11, padding: 4, color: "#16a34a", fontWeight: 600 }}>Confirm</button>}
                      {b.status !== "cancelled" && <button onClick={() => updateStatus(b.booking_id, "cancel")} title="Cancel" style={{ background: "none", border: "none", cursor: "pointer", fontSize: 11, padding: 4, color: "#f59e0b", fontWeight: 600 }}>Cancel</button>}
                      <button onClick={() => deleteBooking(b.booking_id)} title="Delete" style={{ background: "none", border: "none", cursor: "pointer", fontSize: 11, padding: 4, color: "#dc2626", fontWeight: 600 }}>Delete</button>
                    </div>
                  </td>
                </tr>
              ))}
