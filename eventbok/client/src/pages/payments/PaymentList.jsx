...
const methodIcon = { "credit_card": "CC", "debit_card": "DC", "qr_code": "QR", "bank_transfer": "BT" };
                ...
                <tr key={p.payment_id} style={{ borderBottom: "1px solid var(--color-border)" }}>
                  ...
                  <td style={{ padding: "12px 14px" }}>
                    <div style={{ display: "flex", gap: 6 }}>
                      <button onClick={() => setViewing(p)} title="View" style={{ background: "none", border: "none", cursor: "pointer", fontSize: 11, color: "#6b7280", fontWeight: 600 }}>View</button>
                      {p.payment_status === "completed" && <button onClick={() => updateStatus(p.payment_id, "refunded")} title="Refund" style={{ background: "none", border: "none", cursor: "pointer", fontSize: 11, color: "#f59e0b", fontWeight: 600 }}>Refund</button>}
                      {p.payment_status === "pending" && <button onClick={() => updateStatus(p.payment_id, "failed")} title="Cancel" style={{ background: "none", border: "none", cursor: "pointer", fontSize: 11, color: "#dc2626", fontWeight: 600 }}>Cancel</button>}
                    </div>
                  </td>
                </tr>
              ))}
