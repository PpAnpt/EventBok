...
export const organizersApi = {
  ...
  create: (data) => http("/api/organizers", { method: "POST", body: JSON.stringify(data) }),
  update: (id, data) => http(`/api/organizers/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  delete: (id) => http(`/api/organizers/${id}`, { method: "DELETE" }),
};

// Organizer portal (own account)
export const organizerPortalApi = {
  login: (email, phone_number) => http("/api/organizers/login", { method: "POST", body: JSON.stringify({ email, phone_number }) }),
  myConcerts: () => http("/api/organizers/me/concerts"),
  myBookings: () => http("/api/organizers/me/bookings"),
  myStats: () => http("/api/organizers/me/stats"),
};
...
export const venuesApi = {
  ...
  getZones: (id) => http(`/api/venues/${id}/zones`),
  ...
  delete: (id) => http(`/api/venues/${id}`, { method: "DELETE" }),
};
